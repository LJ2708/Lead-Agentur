  ...
  const fetchKPIs = useCallback(async () => {
    ...
    if (DEMO_MODE) {
      setKpis([
        {
          label: "Gesamtumsatz",
          value: "10.918 EH (272.972 \u20AC)",
          trend: "up",
          trendPct: 23,
          sparkline: [180, 200, 220, 240, 255, 265, 273],
        },
        {
        ...
        },
        {
          ...
          trend: "up",
          trendPct: 12,
          sparkline: [17, 18, 19, 19, 20, 21, 21],
        },
        {
          label: "Effektive Termine",
          value: "467",
          trend: "up",
          trendPct: 18,
          sparkline: [280, 310, 340, 370, 400, 430, 467],
        },
        {
          label: "Neukunden",
          value: "43",
          trend: "up",
          trendPct: 22,
          sparkline: [20, 24, 28, 32, 35, 39, 43],
        },
        {
          ...
          trend: "up",
          trendPct: 19,
          sparkline: [210, 220, 230, 238, 245, 250, 254],
        },
        {
          label: "\u00D8 BWS pro Abschluss",
          value: "133.350",
          trend: "up",
          trendPct: 19,
          sparkline: [110000, 115000, 120000, 125000, 128000, 131000, 133350],
        },
      ])
      setLoading(false)
      return
